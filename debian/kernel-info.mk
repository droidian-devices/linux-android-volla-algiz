...
DEVICE_FULL_NAME = Volla Phone Quintus
...
# Defconfig to use
KERNEL_DEFCONFIG = k6877v1_64_k419_halium_defconfig
...
KERNEL_BOOTIMAGE_PATCH_LEVEL = 2024-07
...
# Android property. If you don't want to specify this, leave it undefined,
# FLASH_INFO_CPU will be checked instead.
FLASH_INFO_MODEL = Volla Phone Quintus
...
DEB_TOOLCHAIN = linux-initramfs-halium-generic:arm64, binutils-aarch64-linux-gnu, gcc-4.9-aarch64-linux-android, g++-4.9-aarch64-linux-android, libgcc-4.9-dev-aarch64-linux-android-cross, clang-android-12.0-r416183b
